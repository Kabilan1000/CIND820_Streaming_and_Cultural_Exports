...
1. How do Netflix, Disney+, and Amazon Prime differ in representing international titles by country, genre, and release year?  
2. Can we predict whether a title will be “popular” based on its metadata (platform, genre, country, year, and type)?  
3. What clusters or groupings emerge when titles are grouped by metadata features?  
4. Which platform functions most effectively as a cultural ambassador based on these results?
